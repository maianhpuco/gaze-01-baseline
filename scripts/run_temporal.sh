...
#SBATCH --output=runs/temporal_training.log
#SBATCH --error=runs/temporal_training.err
#SBATCH --gres=gpu:2
...
echo ""
echo "=========================================="
echo "Step 2: Training temporal model..."
echo "=========================================="
# Set to use only 2 GPUs
export CUDA_VISIBLE_DEVICES=2,3
stdbuf -oL -eL python -u main_train_temporal.py --config configs/train_temporal.yaml

echo ""
echo "✓ Temporal training completed!"
