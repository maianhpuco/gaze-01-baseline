...
# UNet Classifier Training Script
# Reproduces exact steps from eye-gaze-dataset/Experiments/main_Unet.py

echo "=================================================="
echo "UNet Classifier Training"
...
NUM_WORKERS=4
GAMMA=1.0
MODEL_TEACHER="timm-efficientnet-b0"
...
echo "  Gamma (cls/seg weight): $GAMMA"
echo "  Encoder: $MODEL_TEACHER"
echo "  Second Loss: $SECOND_LOSS"
echo ""
...
echo ""
if [ -d "$LATEST_MODEL/plots" ]; then
    echo "ROC curves saved in: $LATEST_MODEL/plots/"
    ls -lh "$LATEST_MODEL/plots"/*.png 2>/dev/null || echo "No plots found"
fi

echo ""
echo "UNet training script completed!"
